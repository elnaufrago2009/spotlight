      ...
      <div class="post-inner entry-thumbnail">
        <div class="cs-overlay cs-overlay-simple cs-overlay-ratio cs-ratio-landscape cs-bg-dark">
          <div class="cs-overlay-background">
            ...
            <img width="380" height="200" src="https://s3-us-west-2.amazonaws.com/monases/<?php echo get_the_date('Y/m')?>/<?php echo the_ID()?>_1.jpg" class="attachment-csco-thumbnail size-csco-thumbnail wp-post-image" alt="">
          </div>
